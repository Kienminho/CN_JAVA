...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Student student1 = new Student(null, "Nguyen Thi D", 20, "d@gmail.com", 10.0);
		...
		if (studentToUpdate != null) {
			studentToUpdate.setName("Le Dinh H");
		...
		System.out.println("Students whose name contains the word 'D':");
		Iterable<Student> studentsByNameContaining = studentRepository.findByNameContainingIgnoreCase("D");
